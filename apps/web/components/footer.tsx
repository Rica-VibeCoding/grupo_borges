  ...
  return (
    <footer className="footer" role="contentinfo">
      <div className="grp">
        ...
        <span className="sep" />
        <span className="sb-item"><span className="k">AMB</span><span className="v">prod</span></span>
        <span className="sep" />
        <span className="sb-item"><span className="k">USUÁRIO</span><span className="v">@pavan</span></span>
      </div>
      ...
      <div className="grp">
        ...
        <span className="sep" />
        <span className="sb-item"><span className="k">EXEC</span><span className="v cy">{pad2(kpis.tasks_running)}</span></span>
        <span className="sep" />
        <span className="sb-item"><span className="k">BLQ</span><span className="v warn">{pad2(kpis.tasks_blocked)}</span></span>
        <span className="sep" />
